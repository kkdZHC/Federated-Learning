...
def kmeans_transfer_learning(start_feature,end_feature):
    # 创建边缘设备或本地服务器
    ...
    # 运行联邦学习过程
    num_epochs = 10
    final_global_centroids,scores = fl.transfer_learning_federated_learning(local_devices, num_epochs)
