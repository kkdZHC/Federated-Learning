...
def GMM_transfer_learning(start_feature,end_feature):
    # 创建边缘设备或本地服务器
    filename1 = "transfer_learning1.csv"
    filename2 = "transfer_learning2.csv"
    # start_feature = 1
    # end_feature = 3
    ...
    # 运行联邦学习过程
    num_epochs = 10
    final_global_means,final_global_covariances,scores = fl.transfer_learning_federated_learning(local_devices, num_epochs)

    # 迁移学习联邦学习下聚类结果
    print("迁移学习联邦学习下最终的全局聚类中心:\n",final_global_means)
    print("迁移学习联邦学习下最终的全局协方差矩阵:\n", final_global_covariances)
    print("迁移学习联邦学习下每一轮的K-Means聚类算法下的轮廓系数：")
